...
import type { IDataObject, IExecuteFunctions, INode, IPollFunctions, IHttpRequestOptions } from 'n8n-workflow';
...
describe('n8n guidance never replaces API evidence', () => {
	...
	it('fails visibly if a future API field occupies the reserved namespace', () => {
		expect(() => withN8nGuidance({ postdom_n8n_guidance: evidence }, publishGuidance('published'), errorContext))
